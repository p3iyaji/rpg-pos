        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h2 class="p-5 text-lg">Categories</h2>
                    <div
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <!-- Loading state -->
                                <tr v-if="categoryStore.isLoading && !categoryStore.categories.data?.length"
                                ...
                                <!-- Empty state -->
                                <tr v-else-if="!categoryStore.isLoading && !categoryStore.categories.data?.length"
                                    class="border-b dark:border-gray-700">
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ categoryStore.categories.from ?? 0 }} - {{ categoryStore.categories.to ?? 0 }}
                            </span>
                            of
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ categoryStore.categories.total ?? 0 }}
                            </span>
                        </span>
                        <TailwindPagination :data="categoryStore.categories" @pagination-change-page="fetchNewPage" />
                    </nav>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow dark:bg-gray-700 p-6 max-w-md w-full">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button @click="deleteCategory"
                            ...
                            <span v-if="!categoryStore.isLoading">Delete</span>
