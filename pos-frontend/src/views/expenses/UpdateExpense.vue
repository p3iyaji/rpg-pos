...
onMounted(async () => {
    ...
    const expense = await expenseStore.fetchExpenseById(expenseId);
    console.log(expense);
    try {
...
const updateExpense = async () => {
    expenseStore.errorMessage = {};

    const response = await expenseStore.updateExpense(route.params.id, form.value);
    if (response) {
        Swal.fire({
            toast: true,
            icon: 'success',
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-end pt-4">
                                <button type="submit" :disabled="expenseStore.isLoading"
                                    ...
                                    <span v-if="!expenseStore.isLoading">Update Expense</span>
