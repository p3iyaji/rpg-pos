        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h2 class="p-5 text-lg">Expenses</h2>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <!-- Loading state -->
                                <tr v-if="expenseStore.isLoading && !expenseStore.expenses.data?.length"
                                    ...
                                    <td colspan="7" class="px-4 py-12 text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <span class="ml-2">Loading expenses...</span>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Empty state -->
                                <tr v-else-if="!expenseStore.isLoading && !expenseStore.expenses.data?.length"
                                    class="border-b dark:border-gray-700">
                                    <td colspan="7" class="px-4 py-12 text-center text-gray-500 dark:text-gray-400">
                                        No expenses found
                                    </td>
                                </tr>
                                <tr v-for="expense in expenseStore.expenses.data" :key="expense.id"
                                    class="border-b dark:border-gray-700"
                                    :class="{ 'opacity-50': expenseStore.isLoading && expenseToDelete === expense.id }">
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ expenseStore.expenses.from ?? 0 }} - {{ expenseStore.expenses.to ?? 0 }}
                            </span>
                            of
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ expenseStore.expenses.total ?? 0 }}
                            </span>
                        </span>
                        <TailwindPagination :data="expenseStore.expenses" @pagination-change-page="fetchNewPage" />
                    </nav>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow dark:bg-gray-700 p-6 max-w-md w-full">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button @click="deleteExpense"
                            ...
                            <span v-if="!expenseStore.isLoading">Delete</span>
