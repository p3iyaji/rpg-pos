...
const updateSupplier = async () => {
    supplierStore.errorMessage = {};

    const response = await supplierStore.updateSupplier(route.params.id, form.value);
    ...
    } else if (supplierStore.errorMessage.general) {
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: supplierStore.errorMessage.general[0],
        });
    }
};
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-end pt-4">
                                <button type="submit" :disabled="authStore.isLoading"
                                    ...
                                    <span v-if="!authStore.isLoading">Update Supplier</span>
