...
const mydiscounts = discountStore.fetchDiscounts();
console.log(mydiscounts);
...
const fetchNewPage = (page) => {
    discountStore.fetchDiscounts(page);
}
...
const confirmDelete = (discountId) => {
    discountToDelete.value = discountId;
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h2 class="p-5 text-lg">Discounts</h2>
                    <div
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <!-- Loading state -->
                                <tr v-if="discountStore.isLoading && !discountStore.discounts.data?.length"
                                    ...
                                    <td colspan="7" class="px-4 py-12 text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <span class="ml-2">Loading discounts...</span>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Empty state -->
                                <tr v-else-if="!discountStore.isLoading && !discountStore.discounts.data?.length"
                                    class="border-b dark:border-gray-700">
                                    <td colspan="7" class="px-4 py-12 text-center text-gray-500 dark:text-gray-400">
                                        No discounts found
                                    </td>
                                </tr>
                                <tr v-for="discount in discountStore.discounts.data" :key="discount.id"
                                    class="border-b dark:border-gray-700"
                                    :class="{ 'opacity-50': discountStore.isLoading && discountToDelete === discount.id }">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <button @click="confirmDelete(discount.id)"
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ discountStore.discounts.from ?? 0 }} - {{ discountStore.discounts.to ?? 0 }}
                            </span>
                            of
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ discountStore.discounts.total ?? 0 }}
                            </span>
                        </span>
                        <TailwindPagination :data="discountStore.discounts" @pagination-change-page="fetchNewPage" />
                    </nav>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow dark:bg-gray-700 p-6 max-w-md w-full">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button @click="deleteDiscount"
                            ...
                            :disabled="discountStore.isLoading">
                            <span v-if="!discountStore.isLoading">Delete</span>
