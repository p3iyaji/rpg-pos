...
const deleteUnit = async () => {
    try {
        await unitStore.deleteUnit(unitToDelete.value);
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <!-- Loading state -->
                                <tr v-if="unitStore.isLoading && !unitStore.units.data?.length"
                                    ...
                                    <td colspan="7" class="px-4 py-12 text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <span class="ml-2">Loading units...</span>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Empty state -->
                                <tr v-else-if="!unitStore.isLoading && !unitStore.units.data?.length"
                                    class="border-b dark:border-gray-700">
                                ...
                                <tr v-for="unit in unitStore.units.data" :key="unit.id"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <router-link :to="`/units/${unit.id}/edit`"
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ unitStore.units.from ?? 0 }} - {{ unitStore.units.to ?? 0 }}
                            </span>
                            of
                            <span class="font-semibold text-gray-900 dark:text-white">
                                {{ unitStore.units.total ?? 0 }}
                            </span>
                        </span>
                        <TailwindPagination :data="unitStore.units" @pagination-change-page="fetchNewPage" />
                    </nav>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow dark:bg-gray-700 p-6 max-w-md w-full">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button @click="deleteUnit"
                            ...
                            <span v-if="!unitStore.isLoading">Delete</span>
